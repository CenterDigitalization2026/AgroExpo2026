export const translations = {
  ...
  tj: {
    ...
    hero: {
      badge: "Вазорати кишоварзии Ҷумҳурии Тоҷикистон • БҶҲ ООН (WFP)",
      title: "Digital AgroExpo Tajikistan-2026",
      subtitle:
    ...
    directions: {
      ...
      drones: {
        title: "Дронҳо ва системаҳои ҶИС",
    ...
    registration: {
      ...
      categories: [
        "Сектори давлатӣ (Вазоратҳо, идораҳо)",
      ...
      formats: [
        "Бинобар иштирокчӣ (Expo) — тамошои озоди минтақаҳои демо ва стендҳо",
